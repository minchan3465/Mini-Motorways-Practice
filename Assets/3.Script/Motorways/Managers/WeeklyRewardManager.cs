...
namespace Motorways.Managers {
	...
	public class WeeklyRewardManager : MonoBehaviour {
		...
		public TextMeshProUGUI RewardWeek; //보상 팝업 부모 오브젝트
		...
		public void ShowRewardPopup() {
			...
			if (SimulationManager.Instance != null && !SimulationManager.Instance.IsPaused) {
				SimulationManager.Instance.TogglePause(false);
			}

			RewardWeek.text = ClockProcess.Instance.Model.ExpansionWeek + "주차";
